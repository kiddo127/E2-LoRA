...
DATA_ROOT = os.environ.get("CIL_DATA_ROOT", "./data")
...
class iCARS196_224(iData):
    ...
    def download_data(self):
        train_dir = os.path.join(DATA_ROOT, "cars196/train")
        test_dir = os.path.join(DATA_ROOT, "cars196/val")
...
class vtab(iData):
    ...
    def download_data(self):
        # assert 0, "You should specify the folder of your dataset"
        train_dir = os.path.join(DATA_ROOT, "vtab-cil/vtab/train")
        test_dir = os.path.join(DATA_ROOT, "vtab-cil/vtab/test")
        train_dset = datasets.ImageFolder(train_dir)
        test_dset = datasets.ImageFolder(test_dir)
